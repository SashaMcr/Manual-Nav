...
<div class="form-group">
    ...
    <select data-field="entry-image-select" name="displayImage" class="form-control form-select" style="width: 60%;">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group ccm-block-manualnav-select-icon" style="margin-right: 5px;">
                <select id="icon2" name="<?php echo $view->field('icon') . '[]'; ?>" class="form-control form-select" onchange="iconPreview(this)">
        ...
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input class="form-control form-select" type="text" name="<?php echo $view->field('title'); ?>[]" value="<%=title%>" />
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label><?php echo t('Link'); ?></label>
                        <select data-field="entry-link-select" name="linkType[]" class="form-control form-select">
